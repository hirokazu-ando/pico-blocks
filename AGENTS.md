...
1. Read **`docs/PROJECT-TASKS.md`**: newest block in **Handoff log**, then **Active tasks**.  
2. Follow code style in `js/` and Blockly patterns.  
3. Curriculum refs: `docs/python-learning-site-plan.md`, `docs/curriculum-detail.md`, `docs/curriculum-sakigake-urls.tsv`.
...
- `../../CLAUDE.md` (OneDrive workspace root)  
- `../../rules/session-start.md`  
- `../../????.md` / `../../revision_log.md` (if present)
