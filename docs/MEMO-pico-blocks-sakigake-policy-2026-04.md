# MEMO (as of 2026-04): PycoBlocks, Sakigake curriculum, ops, business
...
- **Policy:** keep **PycoBlocks free and open**; state that in README / site copy.
...
- **Workspace `CLAUDE.md`** — session start **step 5:** when touching PycoBlocks, read `PROJECT-TASKS.md` first; on exit, append Handoff if work was done.
- **`rules/session-start.md`** — PycoBlocks subsection + link to `????.md` one-liner.

---

## 5. Likely next steps

1. Sakigake MVP: landing + lessons 1–3 + PycoBlocks link or embed decision.
